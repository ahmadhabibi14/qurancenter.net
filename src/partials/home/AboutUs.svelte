  ...
  <div class="grid grid-cols-[1fr_40%] gap-9 items-start">
    ...
    <div class="h-fit flex flex-col gap-5">
      <div class="flex flex-col gap-3">
        ...
        <p>Menjadi pusat pembinaan dan pengembangan Al-Qur’an yang unggul dalam melahirkan generasi Qur’ani serta memperkuat dakwah dan organisasi Hidayatullah.</p>
      </div>
